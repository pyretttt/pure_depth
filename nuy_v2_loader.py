...
class NYUV2Dataset(Dataset):
  ...
  def _transform(self, x, y):
    ...
    #   p = v2.RandomResizedCrop.get_params(x, scale=(0.9, 1.0), ratio=(320/224, 320/244))  
    #   x, y = (
    #     v2.functional.resized_crop(x, *p, size=(224, 320)),
    #     v2.functional.resized_crop(y, *p, size=(224, 320))
    #   )
